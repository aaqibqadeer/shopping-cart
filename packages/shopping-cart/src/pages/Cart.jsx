...
import { withAuth, withCart, withLoading } from "../store";

const withHocs = combineHOCs(withAuth, withLoading, withCart);

export const Cart = withHocs(
  ({ authStatus, cart, updateCart, setIsLoading }) => {
    const tableHeader = [
      "Product",
      "Name",
      "Price",
